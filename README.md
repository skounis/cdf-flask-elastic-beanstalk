...
> to work around some permissions issue create your first test application using the AWS Console web UI https://eu-west-1.console.aws.amazon.com/elasticbeanstalk/home?region=eu-west-1#/environments
